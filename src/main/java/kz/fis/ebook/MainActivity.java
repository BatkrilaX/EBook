...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LIST_OF_TOPICS.add("definition/0.htm");
        LIST_OF_TOPICS.add("history/1.htm");
        LIST_OF_TOPICS.add("specifications/2.htm");
        LIST_OF_TOPICS.add("classification/3.htm");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_viewSulpak) { // Переход на внешнюю html-ссылку и внешний браузер
            openLinkExternally("https://www.sulpak.kz/f/naushniki/pavlodar");
        }
        if (id == R.id.nav_viewTechnoDom) {
            openLinkExternally("https://www.technodom.kz/pavlodar/smartfony-i-gadzhety/naushniki/vse-naushniki");
        }
        if (id == R.id.nav_viewFora) {
            openLinkExternally("https://fora.kz/catalog/televizory-audio-video/nausniki/pavlodar");
        }
        if (id == R.id.nav_viewMechta) {
            openLinkExternally("https://www.mechta.kz/section/naushniki/?setcity=pv");
        } else {
            idTopic = id;
